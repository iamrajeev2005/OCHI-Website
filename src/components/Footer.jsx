...
function Footer() {
  return (
    <div className="min-h-screen w-full bg-zinc-100 px-12 flex gap-20 justify-start">
      <div className="flex flex-col justify-between h-screen">
        <div classname="w-1/2 h-screen">
          <h1 className="text-zinc-800 text-[10vw] font-[FG] w-[20%] leading-[7.5vw]">
            EYE-OPENING
          </h1>
        </div>
        <div className="mb-10 text-zinc-800">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
      ...
      <div className="flex flex-col">
        ...
        <div className="text-zinc-800 font-[NU] flex flex-col gap-4 mt-[3vw]">
          <h4>S:</h4>
          <div className="flex flex-col">
            <a href="">Instagram</a>
            <a href="">Behance</a>
        ...
        <div className="text-zinc-800 font-[NU] flex  gap-[20vw] mt-[3vw]">
          <div>
            <h4>L:</h4>
            <div className="flex flex-col w-[60%] mt-3">
              <p>202-1965 W 4th Ave Vancouver, Canada</p>
              <p className="w-[70%] mt-4">30 Chukarina St Lviv, Ukraine</p>
            </div>
          </div>
          <div>
            <h4>M:</h4>
